...
contract MIPS {
    ...
    function handleSyscall() internal returns (bytes32 out_) {
        ...
        // read: Similar behavior as Linux/MIPS with support for unaligned reads.
        ...
        // write: Similar behavior as Linux/MIPS with support for unaligned writes.
        ...
        // fcntl: Similar behavior as Linux/MIPS.
